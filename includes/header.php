      ...
      <div class="collapse navbar-collapse" id="navbar">
        <ul class="navbar-nav ms-auto align-items-center">
          <li class="nav-item mx-2">
            <a class="nav-link active" href="/campus-market/student/dashboard.php">Home</a>
          </li>

          <li class="nav-item mx-2">
            <a class="nav-link"href="/campus-market/student/browse_products.php">Browse Products </a>
          </li>
          ...
          <li class="nav-item mx-2">
            <a class="nav-link" href="/campus-market/student/favorites.php">Favorites </a>
          </li>

          <li class="nav-item ms-3">
            <a class="btn btn-primary-custom" href="/campus-market/student/profile.php">Profile </a>
          </li>
          <li class="nav-item ms-3">
